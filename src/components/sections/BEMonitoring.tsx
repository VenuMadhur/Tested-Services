...
export default function BEMonitoring() {
  return (
    ...
    */
    <section id="be-monitoring" className="relative overflow-hidden bg-premiumCanvas-beMonitoring py-24 sm:py-32">
      <Container>
        <SectionHeading
        ...
        <div className="mt-10 space-y-8">
          {workflows.map((wf, i) => (
            <motion.div
              ...
              className="relative overflow-hidden rounded-3xl border border-white/60 bg-white p-8 shadow-card transition-all duration-300 sm:p-10"
            >
